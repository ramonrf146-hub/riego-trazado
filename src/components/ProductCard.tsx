  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-3xl border border-line-dim/60 bg-ink-2 shadow-xl shadow-black/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-line/10">
      ...
      <div className="flex flex-1 flex-col gap-1.5 p-3">
        ...
        {notaTecnica && (
          <p className="line-clamp-2 flex-1 text-[11px] leading-relaxed text-text-dim">
            {notaTecnica}
          </p>
        )}
        ...
        <div className="mt-auto space-y-1.5">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 rounded-lg bg-accent px-3 py-2 text-xs font-bold text-ink shadow-lg shadow-accent/30 transition-transform active:scale-[0.98]"
          >
            {cta}
            <IconoFlecha />
          </a>
          ...
          {producto.guiaCompra && (
            <Link
              ...
              className="block text-center text-[11px] font-semibold text-text-dim underline-offset-2 hover:text-text-light hover:underline"
            >
